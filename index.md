...
Экспериментальный [банк времени](money/time-bank)

[Правила взаимодействия на проектах](cases/interplay)

В данном контексте стоит 
обратить внимание на метод [скрам-покера](cases/scrum-poker.md) (пока не применяется)
...
[Скрам-покер к вопросу оплаты труда](cases/scrum-poker.md)

[Труд и его оплата](cases/work)

[Совместные проекты на изначально неравных условиях.](cases/common-contract)
